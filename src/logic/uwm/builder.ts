...
export class Builder {
    ...
    public put (
        ...
        switch (cmd) {
            case Command.V3_SWAP_EXACT_OUT: this.put0x01(input); break
            case Command.PERMIT2_TRANSFER_FROM: this.put0x02(input); break
            case Command.PAY_PORTION: this.put0x06(input); break
            case Command.PERMIT2_PERMIT: this.put0x0a(input); break
            default: throw new Error('Builder: unexpected command')
        }
