...
export const Bitcoin = (props: AllType) => {
    ...
    if (availableAssets)
      setAmount(
        ethers.utils.formatUnits(
          props.amount,
          availableAssets.btc.bitcoin.decimals
        )
      );
  }, [availableAssets]);
  ...
  return (
    <div>
      ...
      >
        Send Bitcoin <img  style={{height: "25px"}} src={bitcoin} />
      </h2>
      <div
        style={{
          margin: "0 auto",
      ...
      >
        <QRCode
          ...
          value={`bitcoin:${props.address}?value=${amount}`}
        />
        ...
        <Card>
          ...
          >
            <span style={{ width: "100%" }}>
              {`Check the amount you send in BITCOIN, in case it will be
